...
enum TriggerType {signal, interaction, approach, init, hotspot}
...
class NpcActionTrigger {
  ...
  static NpcActionTrigger npcActionTriggerfromJson(Map<String, dynamic> json) {
    ...
    } else if (json.containsKey('onHotspot')){
      return NpcActionTrigger(type: TriggerType.hotspot, value: json['onHotspot']);
    }
